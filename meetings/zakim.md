...
<body>
	...
	<div class="toc">
		...
		<li><a href="#questions">Question Tracking</a> &bull; </li>
...
facilitate meetings using IRC.</p>

<p>It is generally available on W3C's IRC server,
under the "Zakim" nickname.</p>
...
<a id="identifying"></a>
<h2 id="info">Identifying your particular teleconference</h2>

<h3 id="startmeeting">Start a meeting</h3>

<ul class="command">
  <li>  <kbd>start [the | this] meeting</kbd></li>
  <li>  <kbd>prepare [the | this] meeting</kbd></li>
</ul>

<p>Invite <a href="http://www.w3.org/2002/03/RRSAgent">RRSAgent</a> to the current channel, provide the expected access
...
<p>The two forms of this command do the same thing; some people set things up in the channel well before the meeting is scheduled to start and the 'prepare' synonym reduces confusion for others who are already on the channel.</p>

<h3 id="endmeeting">End a meeting</h3>

<ul class="command">
  <li>  <kbd>end [the | this] meeting</kbd></li>
</ul>

<p>Displays a final list of those who were recognized as being present
during the meeting, requests 
<a href="http://www.w3.org/2002/03/RRSAgent">RRSAgent</a> to
create the formatted meeting record, and then departs (see 'bye').</p>

<h3 id="description">Provide a description for the teleconference on the current IRC channel</h3>

<ul class="command">
  <li>  <kbd>this [conference] is &lt;description&gt;</kbd></li>
</ul>    
...
<pre class="example">[16:43] &lt;Alan&gt; zakim, this is WebEx 640 999 321
[16:43] &lt;Zakim&gt; ok, Alan</pre>


<h3 id="describe">Request the full name of the conference that is associated with the current IRC channel.</h3>
<ul class="command">
  <li>  <kbd>what conference is this?</kbd></li>
...
<p>Returns the conference description that was previously entered.</p>

<h3 id="savedescription">Saving a conference description for future meetings</h3>

<p class="command"><kbd>save this conference description</kbd></p>

<p>If the conference description will apply to future teleconferences
  ...
  not be saved when Zakim restarts unless you use this command.</p>

<a id="attendance"></a>
<h2>Attendance reports</h2>

<h3 id="present">Announcing your presence</h3>

<p class="command"><kbd>present+ [&lt;name&gt;]</kbd></p>

<p class="def">Informs Zakim and all others present on the irc channel
  ...
  when you enter the meeting room to which the conference is connected.</p>

<p>Zakim previously was able to announce the arrival of new teleconference
participants automatically.  This is no longer the case; you must now tell
Zakim that you have joined the teleconference.</p>

<p>If you omit &lt;name&gt; Zakim will use your irc nick.</p>

<p class="command"><kbd>present- [&lt;name&gt;]</kbd></p>

<p class="def">Informs Zakim and all others present on the irc channel
  that you have left the teleconference.</p>

<p>Good practice is to inform others when you leave or drop off the
  teleconference or leave the meeting room.</p>

<h3 id="whoshere">Produce a report of the current participants in your conference</h3>
...
<pre class="example">[17:06] &lt;Alan&gt; zakim, who's here?
[17:06] &lt;Zakim&gt; Present: Alan, Dan, gerald</pre>

<h3 id="listparticipants">Produce a report of the names of all participants</h3>
...
<pre class="example">[17:19] &lt;Alan&gt; zakim, excuse us
...
<h3 id="handup">Add name(s) to the queue of individuals wishing to speak</h3>
...
<h3 id="qplus">Add name to the queue of individuals wishing to speak</h3>
...
<h3 id="qqplus">Add name to the speaker queue to react to the current speaker</h3>

<ul class="command">
	<li><kbd>qq+ [&lt;name&gt;] [also] to &lt;note&gt;</kbd></li>
</ul>    

<p>The mnemonic is "quick queue+".  This
...
<h3 id="qminus">Remove name(s) from the queue of individuals wishing to speak</h3>
...
<h3 id="qlater">Move the speaker to the end of the queue</h3>
...
<h3 id="qpluslater">Add the irc nick issuing the request to the end of the speaker
...
<h3 id="queueequals">Place name(s) on the queue of individuals wishing to speak</h3>
...
<h3 id="q">Display the queue of individuals wishing to speak</h3>
...
<p>An ordered list of the names of those waiting to speak is shown.</p>

<p>'queue' can also be abbreviated to just 'q' in the first two forms.</p>

<h3 id="vq">Display the speaker queue with notes (verbose queue)</h3>

<ul class="command"><li><kbd>[please show the] full queue</kbd></li>
<li><kbd>[please show the] verbose queue</kbd></li>  
<li><kbd>vqueue?</kbd></li>
<li><kbd>vq?</kbd></li>
<li><kbd>qv?</kbd></li>
</ul>
...
<p>An ordered list of the names of those waiting to speak is shown along
 with any notes they have entered about why they have asked to speak.</p>

<h3 id="ack">Grant &lt;name&gt; permission to speak</h3>

<ul class="command"><li><kbd>[chair] recognize[s] &lt;name&gt;</kbd></li>
<li><kbd>[chair] ack[s] &lt;name&gt;</kbd></li>
</ul>
    <p>If &lt;name&gt; matches the start of exactly one name
...
<h3 id="acknext">Grant the first person on the speaker queue permission to speak</h3>
...
<h3 id="closequeue">Close the queue</h3>
...
<h3 id="openqueue">Reopen the queue</h3>
...
<h3 id="lastword">Giving the Last Word</h3>
...
<h3 id="queuetimer">Timer for speakers</h3>
...
<h3 id="stopqueue">Stop tracking Queue</h3>
...
<h3 id="startqueue">Start Tracking Queue</h3>
...
<h3 id="agendaplus">Add an agenda item</h3>
...
<h3 id="displayagenda">Display the agenda</h3>
...
<h3 id="modifyitem">Modify an agenda item</h3>
...
<h3 id="dropitem">Drop an item from the agenda</h3>
...
<h3 id="takeup">Open the discussion about an agenda item</h3>
...
<h3 id="nextitem">Move to the next agenda item</h3>
...
<h3 id="timeitem">Create a reminder</h3>

<ul class="command">
	<li><kbd>give this [agenda] item &lt;n&gt; minutes</kbd></li>
...
<h3 id="agendaorder">Reorder the agenda</h3>
...
<h3 id="currentitem">What is the current agenda item?</h3>
...
<h3 id="closeitem">Close an agenda item</h3>
...
<h3 id="skipitem">Defer an item on the agenda</h3>
...
<ul class="command"><li><kbd>[please] read agenda from &lt;uri&gt;</kbd></li>
    ...
    <p>Takes <em>uri</em> as a file of RDF/XML and queries it for
     ...
     a <a href="http://blog.whatfettle.com/2006/07/04/rdf-agenda-scraper/"
...
<h3 id="saveagenda">Save agenda to W3C Web site</h3>
...
<h3 id="reminder">Program a reminder alarm</h3>
...
<h3 id="ignoreagenda">Stop tracking agenda changes</h3>
...
<h3 id="trackagenda">Start tracking agenda changes</h3>
...
<a id="pickscribe"></a>
<h3 id="pickvictim">Minute-Taking (Scribe)</h3>
...
<li><kbd>... other than &lt;names&gt;</kbd></li>
<li><kbd>... except &lt;names&gt;</kbd></li>
</ul>    

<p>Randomly selects a minute-taker from the current participants. 
...
<h2 id="questions">Question Tracking</h2>

<p>Zakim will help track a list of questions requested during a
  ...
  received as third person ('/me') messages.</p>

<h3 id="questionplus">Add a question</h3>

<ul class="command">
  <li><kbd>question+ &lt;text&gt;</kbd></li>
</ul>

<p>Adds a question described by &lt;text&gt; to a list of questions,
  ...
  may be abbreviated to 'quest' or 'ques'.</p>

<pre class="example">[17:13] &lt;Ralph&gt; question+ When is this needed?
[17:13] * Zakim notes question 1 added
[17:13] &lt;Ralph&gt; question+ How will this work?
[17:13] * Zakim notes question 2 added</pre>

<h3 id="listquestions">Display the list of questions</h3>

<ul class="command">
  <li><kbd>list [the] questions</kbd></li>
  <li><kbd>show [the] questions</kbd></li>
  <li><kbd>questions?</kbd></li>
  <li><kbd>list all [the] questions</kbd></li>
  <li><kbd>show all [the] questions</kbd></li>
</ul>

<p>Displays the questions and the number of supporters of each
  question.  The first three forms are equivalent and only display
  questions that have not been dropped or closed.</p>

<pre class="example">[17:13] &lt;Ralph&gt; list questions
[17:13] * Zakim sees 2 questions remaining:
[17:13] * Zakim Q1: When is this needed? (1 supporter)
[17:13] * Zakim Q2: How will this work? (1 supporter)</pre>

<h3 id="supportquestion">Support a question</h3>

<ul class="command">
  <li><kbd>question &lt;number&gt;++</kbd></li>
  <li><kbd>question++ &lt;number&gt;</kbd></li>
</ul>

<p>Indicates that you are interested in the answer to a question.
  ...
  recognized, though technically imprecise.</p>

<pre class="example">[17:17] &lt;OtherPerson&gt; question 2++
...
[17:17] * Zakim Q1: When is this needed? (1 supporter)</pre>

<h3 id="cancelquestionsupport">Cancel support of a question</h3>
...
<p>Indicates that you are no longer interested in the answer to a
  question. The keyword 'question' may be abbreviated to 'quest' or
  'ques'. A single '-' is recognized, though technically
  imprecise.</p>

<pre class="example">[17:18] &lt;OtherPerson&gt; question 2--
...
[17:18] * Zakim Q2: How will this work? (1 supporter)</pre>

<h3 id="dropquestion">Drop or close a question</h3>

<ul class="command">
  <li><kbd>drop question &lt;number&gt;</kbd></li>
  <li><kbd>close question &lt;number&gt;</kbd></li>
</ul>

<p>Drops (removes) a question from the list of questions.  The two
  forms are equivalent. The keyword 'question' may be abbreviated to
  'quest' or 'ques'.</p>

<pre class="example">[17:19] &lt;Ralph&gt; drop question 1
...
[17:20] * Zakim Q2: How will this work? (1 supporter)</pre>

<h3 id="clearquestions">Clear the list of questions</h3>

<ul class="command">
  <li><kbd>[please] clear [the] questions</kbd></li>
</ul>

<p>Clears (erases) all questions from the list of questions.</p>

<pre class="example">[17:50] &lt;Ralph&gt; clear the questions
[17:50] * Zakim notes questions cleared
[17:50] &lt;Ralph&gt; questions?
[17:50] * Zakim sees no questions</pre>

<h2 id="changes">Change History</h2>

<h3>2021-01</h3>

<p>Added question management.  Added 'other than' support for 'pick a scribe'.
  Fixed the bug that clearing the agenda failed to reset all agenda state.</p>

<h3>2020-04</h3>

<p>'prepare meeting' synonym for 'start meeting', experimental 'qq+' added.</p>

<h3>2019-12</h3>

<p>'verbose queue?', 'start meeting', and 'end meeting' added.</p>

<h3>2015-07</h3>

<p>W3C decommissioned the bridge hardware that provided many additional
  ...
  between Zakim and a particular teleconference system.</p>
...
<p>The Zakim teleconference bridge was a customized
<a href="http://www.compunetix.com">Compunetix</a>
Contex Conferencing system.  Thanks to Compunetix for providing
technical details that enabled the original development of W3C's Zakim tools.</p>

<p><a id="name"><em>Why is this called 'Zakim'?</em></a></p>
...
advocate <a href="https://en.wikipedia.org/wiki/Leonard_P._Zakim"
...
decommissioned we retained the name of this bot to not forget the past.</p>
