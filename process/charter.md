...
Evaluate readiness
: Let the proponents know if the charter is not well-formed (per the template and per Process section "[content of a charter](/policies/process/#WGCharter)"); if it is perceived to be harmful to the Web; or if it is not a priority at the current time.
